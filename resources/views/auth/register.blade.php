<x-guest-layout>
    <div class="flex flex-col min-h-screen bg-local bg-no-repeat bg-cover bg-center justify-center items-center" style="background-image: url('/images/iclt_gerbang.jpeg')">
        <div class=" bg-white shadow-lg rounded-lg sm:rounded-xl">
